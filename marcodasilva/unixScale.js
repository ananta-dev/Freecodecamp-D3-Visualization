...
!(function (t, n) {
    ...
    function zn(t) {
        ...
        return (
            i === o && o === a
                ? (e = r = u)
                : ((e = qn(
                      (0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / An
                  )),
                  (r = qn(
                      (0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Sn
                  ))),
    ...
    function br(t, n, e, r, i, o) {
        ...
        !(function (t, n, e) {
            ...
            function u() {
                for (var r in ((e.state = _r), e.timer.stop(), delete i[n], i))
                    return;
    ...
    function Pi(n) {
        ...
        return (
            ...
            (s.prototype = {
                ...
                emit: function (t) {
                    St(
                        new li(u, t, n.output(this.state.selection)),
                        o.apply,
                        o,
    ...
    (fa.copy = function () {
        ...
        (fa.visitAfter = function (t) {
            ...
            for (
                this._root &&
                e.push(
                    new ra(this._root, this._x0, this._y0, this._x1, this._y1)
                );
                (n = e.pop());
    ...
    var Aa = {
        ...
        s: function (t, n) {
            ...
            var r = e[0],
                ...
                o =
                    i -
                    (ma = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) +
                    1,
                a = r.length;
            return o === a
                ? r
    ...
    function za(t, n) {
        return Math.max(
            0,
            3 * Math.max(-8, Math.min(8, Math.floor(ba(n) / 3))) -
                ba(Math.abs(t))
        );
    }
    function Ra(t, n) {
        ...
        od = $h(
            ...
            function (t, n) {
                return (
                    (n -
                        t -
                        (n.getTimezoneOffset() - t.getTimezoneOffset()) * Qh) /
                    864e5
                );
            },
            function (t) {
    ...
    function Nb(t, n) {
        var e,
            ...
            o = t.sort(Mb).pop();
        for (
            mb = [], _b = new Array(t.length), yb = new X_(), bb = new X_();
            ;
    ...
    (Eb.prototype = Sb.prototype),
                    ...
                    for (u = 0, i = new Array(f); u < s; ++u)
                        ((c = t[u]).index = u),
                            "object" != typeof c.source &&
                                (c.source = da(l, c.source)),
                            "object" != typeof c.target &&
                                (c.target = da(l, c.target)),
        ...
        (t.geoCircle = function () {
            ...
            return (
                (a.center = function (t) {
                    return arguments.length
                        ? ((e =
                              "function" == typeof t ? t : kc([+t[0], +t[1]])),
                          a)
                        : e;
                }),
                (a.radius = function (t) {
        ...
        (t.tree = function () {
            ...
            function i(i) {
                var c = (function (t) {
                    for (
                        var n, e, r, i, o, a = new Wl(t, 0), u = [a];
                        (n = u.pop());
        ...
        (t.pie = function () {
            ...
            function a(a) {
                var u,
                    ...
                    y = Math.min(
                        sy,
                        Math.max(-sy, i.apply(this, arguments) - g)
                    ),
